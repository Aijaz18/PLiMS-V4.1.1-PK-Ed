          ...
          <div className="md:col-span-2 space-y-6">
            <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-xl bg-[#18181b] border border-[#27272a]">
                  ...
                  <p className="text-[11px] text-[#a1a1aa] mt-1">Tailwind CSS v4, Lucide React, Framer Motion, Offline PWA Service Workers & LocalStorage Queue.</p>
                </div>
                <div className="p-4 rounded-xl bg-[#18181b] border border-[#27272a]">
                  ...
                  <p className="text-[11px] text-[#a1a1aa] mt-1">Sanctum RBAC tokens, Redis queue processing, MySQL 8 full-text indexing, and Gemini GenAI SDK.</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="p-3 rounded-xl bg-[#18181b] border border-[#27272a] text-center">
                  <div className="text-xs font-bold text-indigo-400">MARC21</div>
                  <div className="text-[10px] text-[#a1a1aa] mt-0.5">Machine Readable Cataloging</div>
                </div>
                <div className="p-3 rounded-xl bg-[#18181b] border border-[#27272a] text-center">
                  <div className="text-xs font-bold text-emerald-400">RDA</div>
                  <div className="text-[10px] text-[#a1a1aa] mt-0.5">Resource Description & Access</div>
                </div>
                <div className="p-3 rounded-xl bg-[#18181b] border border-[#27272a] text-center">
                  <div className="text-xs font-bold text-amber-400">DDC 23</div>
                  <div className="text-[10px] text-[#a1a1aa] mt-0.5">Dewey Decimal Classification</div>
                </div>
                <div className="p-3 rounded-xl bg-[#18181b] border border-[#27272a] text-center">
                  <div className="text-xs font-bold text-purple-400">Z39.50 / OAI</div>
                  <div className="text-[10px] text-[#a1a1aa] mt-0.5">Federated Search & Harvesting</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={idx} className="p-4 rounded-xl bg-[#18181b] border border-[#27272a] space-y-1.5">
                ...
                <p className="text-xs text-[#a1a1aa]">{comp.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#a1a1aa] mt-1">Standard RESTful API routing structure for enterprise integration</p>
            </div>
            <button
              onClick={() => handleCopy(sampleLaravelControllerCode, 'laravel_code')}
              className="px-3 py-1.5 rounded-lg bg-[#18181b] border border-[#27272a] text-xs font-semibold text-slate-300 hover:text-white flex items-center space-x-1.5 cursor-pointer"
            >
              <Copy className="h-3.5 w-3.5" />
          ...
          <pre className="p-4 rounded-xl bg-[#09090b] border border-[#27272a] text-xs font-mono text-emerald-400 overflow-x-auto max-h-96">
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#a1a1aa] mt-1">Complete database structure for multi-campus library automation</p>
            </div>
            <button
          ...
          <pre className="p-4 rounded-xl bg-[#09090b] border border-[#27272a] text-xs font-mono text-amber-300 overflow-x-auto max-h-96">
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-[#a1a1aa] mt-1">Click a entity box to highlight its foreign key relationships</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-3 p-6 rounded-xl bg-[#09090b] border border-[#27272a] relative overflow-x-auto min-h-[400px] flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                {[
                  ...
                  return (
                    ...
                    >
                      <div className="text-xs font-bold font-mono text-white flex items-center justify-between pb-2 border-b border-[#27272a]">
                        <span>{tbl.title}</span>
                        <Key className="h-3 w-3 text-amber-400" />
                      </div>
                      <ul className="mt-2 space-y-1 text-[11px] font-mono text-[#a1a1aa]">
            ...
            <div className="p-4 rounded-xl bg-[#18181b] border border-[#27272a] space-y-3">
              ...
              {selectedTableEr ? (
                ...
                <p className="text-xs text-[#71717a]">Select a table box to view detailed key links.</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-[#18181b] border border-[#27272a] space-y-2">
              ...
              <pre className="p-3 rounded-lg bg-[#09090b] text-xs font-mono text-slate-300">
                npm install{'\n'}npm run build{'\n'}npm run preview
              </pre>
            </div>
        ...
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a] space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-[#a1a1aa] mt-1">Operational procedures for librarians, catalogers, and system administrators</p>
            </div>
            <div className="relative w-full sm:w-64">
              <Search className="h-4 w-4 text-[#a1a1aa] absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="text"
                placeholder="Search manual topics..."
                value={searchManual}
                onChange={e => setSearchManual(e.target.value)}
                className="w-full pl-9 pr-3 py-2 rounded-xl bg-[#18181b] border border-[#27272a] text-xs text-white focus:outline-none focus:border-indigo-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            {filteredManual.map(sec => (
              <div key={sec.id} className="p-5 rounded-xl bg-[#18181b] border border-[#27272a] space-y-2">
                <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-[#a1a1aa] leading-relaxed">{sec.content}</p>
              </div>
            ))}
          </div>
        </div>
