...
export const SettingsModule: React.FC<SettingsModuleProps> = ({
  ...
  const themesList: { id: AppTheme; name: string; desc: string; colors: string; badge: string }[] = [
    {
      id: 'pakistan-flag',
      name: '🇵🇰 Pakistani Flag (Green & White)',
      desc: 'National flag emerald green header, white workspace canvas, and gold emblems',
      colors: 'bg-[#00401a] border-emerald-500 text-white',
      badge: 'PAKISTAN FLAG'
    },
    {
      id: 'pakistan-dark',
      name: '🇵🇰 Emerald Night (Dark Green)',
      desc: 'Dark emerald green background with high-contrast mint text and gold highlights',
      colors: 'bg-[#031c10] border-emerald-600 text-emerald-300',
      badge: 'EMERALD NIGHT'
    },
    {
      id: 'light-clean',
      name: '☀️ Academic Clean Light',
      desc: 'Crisp white and light slate background ideal for bright library environments',
      colors: 'bg-white border-slate-300 text-slate-800',
      badge: 'LIGHT CLEAN'
    },
    {
      id: 'dark-slate',
      name: '🌙 Executive Slate Dark',
      desc: 'Dark slate executive atmosphere for low-light reading rooms and monitors',
      colors: 'bg-[#09090b] border-[#27272a] text-[#fafafa]',
      badge: 'DARK SLATE'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-[#27272a] pb-4">
        ...
        <p className="text-xs text-[#a1a1aa]">Configure institution details, loan limits, fine rates, account password, and librarian visual theme preferences</p>
      </div>
      ...
      {currentUser && (
        <div className="p-6 rounded-2xl border border-emerald-500/40 bg-gradient-to-r from-[#121214] via-[#151518] to-emerald-950/20 space-y-4 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#27272a] pb-4">
            ...
            <div className="flex items-center space-x-2 text-xs font-mono text-zinc-400 bg-[#09090b] px-3 py-1.5 rounded-xl border border-[#27272a]">
          ...
          <form onSubmit={handlePasswordSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2.5 text-xs text-[#fafafa] focus:outline-none focus:border-emerald-500 font-mono pr-10"
                />
                <button
                  type="button"
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2.5 text-xs text-[#fafafa] focus:outline-none focus:border-emerald-500 font-mono"
              />
            </div>
      ...
      {onChangeTheme && (
        <div className="p-6 rounded-2xl border border-[#27272a] bg-[#121214] space-y-4">
          <div className="flex items-center space-x-2 border-b border-[#27272a] pb-3">
            ...
            <h3 className="text-sm font-bold text-[#fafafa]">Librarian Visual Theme Choice</h3>
          </div>
          <p className="text-xs text-[#a1a1aa]">Select your preferred interface color scheme. Choose between the official Pakistani Flag Green & White, Emerald Night, Academic Light, or Executive Dark Slate.</p>
            ...
            {themesList.map((t) => {
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl border text-left transition-all cursor-pointer relative flex flex-col justify-between space-y-2 ${
                    isSelected
                      ? 'border-emerald-500 bg-emerald-500/10 ring-1 ring-emerald-500'
                      : 'border-[#27272a] bg-[#09090b] hover:border-emerald-500/40'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-xs text-[#fafafa] flex items-center space-x-1.5">
                      <span>{t.name}</span>
                    </span>
                    {isSelected && (
                      <span className="flex items-center space-x-1 text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-500 text-white font-bold">
                        <Check className="h-3 w-3" />
                        <span>ACTIVE</span>
                      </span>
                    )}
                  </div>
                  <p className="text-[11px] text-[#a1a1aa] leading-relaxed">{t.desc}</p>
                  <div className="pt-1">
                    <span className="text-[9px] font-mono px-2 py-0.5 rounded border border-[#27272a] bg-[#121214] text-[#a1a1aa]">
                      {t.badge}
                    </span>
                  </div>
                </button>
      ...
      <div className="p-6 rounded-2xl border border-blue-500/30 bg-gradient-to-r from-blue-950/20 via-[#121214] to-indigo-950/20 space-y-6 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#27272a] pb-4">
          <div>
            <div className="flex items-center space-x-2 text-sm font-bold text-white">
              <Video className="h-5 w-5 text-cyan-400" />
              <span>Application Viewport Background Media & URL Settings</span>
              <Sparkles className="h-4 w-4 text-amber-400" />
            </div>
            <p className="text-xs text-[#a1a1aa] mt-0.5">
              Set custom web URLs or upload files for background images and video loops across the portal.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs flex items-center space-x-2 transition-all cursor-pointer shadow-lg shadow-blue-500/20 shrink-0"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button
              ...
              onClick={() => {
                ...
                handleUpdateBgConfig(updated, 'Background mode changed to Obsidian Gradient.');
              }}
              className={`p-3.5 rounded-xl border text-left cursor-pointer transition-all flex items-center justify-between ${
                bgConfig.bgType === 'gradient'
                  ? 'border-blue-500 bg-blue-500/20 text-white ring-2 ring-blue-500/30 font-bold'
                  : 'border-[#27272a] bg-[#18181b] hover:border-zinc-500 text-zinc-300'
              }`}
            >
              <div className="flex items-center space-x-2.5">
                <Palette className="h-4 w-4 text-blue-400" />
                <span className="text-xs">Dark Obsidian Gradient</span>
              </div>
              {bgConfig.bgType === 'gradient' && <Check className="h-4 w-4 text-blue-400" />}
            </button>
            ...
            <button
              ...
              className={`p-3.5 rounded-xl border text-left cursor-pointer transition-all flex items-center justify-between ${
                bgConfig.bgType === 'image'
                  ? 'border-emerald-500 bg-emerald-500/20 text-white ring-2 ring-emerald-500/30 font-bold'
                  : 'border-[#27272a] bg-[#18181b] hover:border-zinc-500 text-zinc-300'
              }`}
            >
              <div className="flex items-center space-x-2.5">
              ...
              {bgConfig.bgType === 'image' && <Check className="h-4 w-4 text-emerald-400" />}
            </button>
            ...
            <button
              ...
              className={`p-3.5 rounded-xl border text-left cursor-pointer transition-all flex items-center justify-between ${
                bgConfig.bgType === 'video'
                  ? 'border-cyan-500 bg-cyan-500/20 text-white ring-2 ring-cyan-500/30 font-bold'
                  : 'border-[#27272a] bg-[#18181b] hover:border-zinc-500 text-zinc-300'
              }`}
            >
              <div className="flex items-center space-x-2.5">
              ...
              {bgConfig.bgType === 'video' && <Check className="h-4 w-4 text-cyan-400" />}
            </button>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl border border-[#27272a] bg-[#18181b] space-y-3">
          <div className="flex items-center justify-between">
            ...
            <label className="text-[11px] text-emerald-400 hover:underline flex items-center space-x-1 cursor-pointer">
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-xl border border-[#27272a] bg-[#09090b] text-xs text-white placeholder-zinc-500 focus:border-emerald-500 focus:outline-none"
              />
            </div>
            <button
              type="button"
        ...
        <div className="p-4 rounded-xl border border-[#27272a] bg-[#18181b] space-y-3">
          <div className="flex items-center justify-between">
            ...
            <label className="text-[11px] text-cyan-400 hover:underline flex items-center space-x-1 cursor-pointer">
              <Upload className="h-3.5 w-3.5" />
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-xl border border-[#27272a] bg-[#09090b] text-xs text-white placeholder-zinc-500 focus:border-cyan-500 focus:outline-none"
              />
            </div>
            <button
              type="button"
        ...
        <div className="p-3.5 rounded-xl border border-[#27272a] bg-[#09090b] flex items-center justify-between text-xs">
          <div className="flex items-center space-x-3">
            <span className="text-[#a1a1aa]">Active Background Config:</span>
          ...
          <button
            type="button"
            onClick={() => {
              handleUpdateBgConfig(DEFAULT_BG_CONFIG, 'Background reset to default Obsidian Gradient.');
            }}
            className="text-[11px] text-zinc-400 hover:text-white flex items-center space-x-1 cursor-pointer"
          >
      ...
      <div className="p-6 rounded-2xl border border-emerald-500/30 bg-gradient-to-r from-emerald-950/20 via-[#121214] to-teal-950/20 space-y-4 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#27272a] pb-4">
          <div className="flex items-center space-x-3">
            <div className="p-3 rounded-xl bg-emerald-600/20 text-emerald-400 border border-emerald-500/30 shrink-0">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h3 className="text-sm font-bold text-white">PLiMS Open Source Software License</h3>
                <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-[10px] font-mono font-bold uppercase">
                  MIT License
                </span>
              </div>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center space-x-2 transition-all cursor-pointer shadow-lg shadow-emerald-500/20 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs text-zinc-300">
          <div className="p-3 rounded-xl bg-[#09090b] border border-[#27272a]">
            <span className="text-emerald-400 font-bold block mb-1">✓ Commercial & Academic Use</span>
            <span className="text-[11px] text-[#a1a1aa]">Free to run across any school, college, or university library.</span>
          </div>
          <div className="p-3 rounded-xl bg-[#09090b] border border-[#27272a]">
            <span className="text-blue-400 font-bold block mb-1">✓ Full Code Customization</span>
            <span className="text-[11px] text-[#a1a1aa]">Modify components, catalog schemas, and workflows freely.</span>
          </div>
          <div className="p-3 rounded-xl bg-[#09090b] border border-[#27272a]">
            <span className="text-purple-400 font-bold block mb-1">✓ Open Distribution</span>
            <span className="text-[11px] text-[#a1a1aa]">Share and contribute under standard MIT copyright notice terms.</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 rounded-2xl border border-[#27272a] bg-[#121214] space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#27272a] pb-4">
          <div>
            <div className="flex items-center space-x-2 text-sm font-bold text-[#fafafa]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pt-1">
          {settings.branches.map((branchName, idx) => {
            ...
            return (
              <div
                key={branchName}
                className="p-4 rounded-xl border border-[#27272a] bg-[#09090b] space-y-3 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-xs text-[#fafafa] flex items-center space-x-1.5">
                  ...
                  <div className="mt-2 text-[11px] text-[#a1a1aa] flex items-center space-x-2">
                    <Users className="h-3.5 w-3.5 text-blue-400" />
                    <span>Assigned Staff: <strong className="text-[#fafafa]">{branchStaff.length} Member(s)</strong></span>
                  </div>
                  ...
                  <div className="mt-2 space-y-1">
                    {branchStaff.slice(0, 3).map(staff => (
                      <div
                        key={staff.id}
                        className="p-1.5 rounded-lg bg-[#121214] border border-[#27272a] flex items-center justify-between text-[11px]"
                      >
                        <div className="flex items-center space-x-2 truncate">
                          ...
                          />
                          <span className="font-medium text-[#fafafa] truncate">{staff.name}</span>
                        </div>
                    ...
                    {branchStaff.length > 3 && (
                      <p className="text-[10px] text-[#a1a1aa] font-mono pl-1">
                ...
                <div className="pt-2 border-t border-[#27272a]/60 flex items-center justify-between">
                  <span className="text-[10px] text-[#a1a1aa] font-mono">Status: ACTIVE NODE</span>
                  <div className="flex items-center space-x-2">
      ...
      <div className="p-6 rounded-2xl border border-emerald-500/30 bg-[#121214] space-y-4">
        <div className="flex items-center justify-between border-b border-[#27272a] pb-3">
          <div className="flex items-center space-x-2">
            <ShieldCheck className="h-5 w-5 text-emerald-400" />
            <h3 className="text-sm font-bold text-[#fafafa]">XAMPP Localhost & Desktop Portable Setup Exporter</h3>
          </div>
...
`;
            ...
            className="p-3.5 rounded-xl border border-emerald-500/40 bg-[#09090b] hover:bg-emerald-500/10 text-emerald-300 font-bold text-xs flex flex-col space-y-1 text-left transition-all cursor-pointer"
          >
...
?>`;
            ...
            className="p-3.5 rounded-xl border border-blue-500/40 bg-[#09090b] hover:bg-blue-500/10 text-blue-300 font-bold text-xs flex flex-col space-y-1 text-left transition-all cursor-pointer"
          >
            <span className="flex items-center space-x-1.5">
...
`;
            ...
            className="p-3.5 rounded-xl border border-purple-500/40 bg-[#09090b] hover:bg-purple-500/10 text-purple-300 font-bold text-xs flex flex-col space-y-1 text-left transition-all cursor-pointer"
          >
            <span className="flex items-center space-x-1.5">
      ...
      <form onSubmit={handleSubmit} className="p-6 rounded-2xl border border-emerald-500/30 bg-[#121214] space-y-6 text-xs shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#27272a] pb-4">
          <div className="flex items-center space-x-3">
            <div className="p-3 rounded-xl bg-emerald-600/20 text-emerald-400 border border-emerald-500/30 shrink-0">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-[#a1a1aa] font-medium block">Library System Name</label>
              <input
                type="text"
                required
                value={form.libraryName || ''}
                onChange={e => setForm({ ...form, libraryName: e.target.value })}
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-emerald-500 font-medium"
              />
            </div>

            <div className="space-y-1">
              <label className="text-[#a1a1aa] font-medium block">Parent Institution / University Name</label>
              <input
                type="text"
                required
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-blue-500 font-medium"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-red-500 font-medium"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-amber-500 font-medium"
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 pt-2 border-t border-[#27272a]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-purple-500 font-medium"
              />
            </div>
          ...
          <div className="space-y-1 pt-1">
            <label className="text-[#a1a1aa] font-medium block">Custom Portal Banner / Welcome Notice</label>
            <input
              type="text"
        ...
        <div className="space-y-3 pt-2 border-t border-[#27272a]">
          <h4 className="text-xs font-bold text-zinc-300 flex items-center space-x-1.5 uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <label className="text-[#a1a1aa] font-medium block">Student Max Issue Days</label>
              <input
                type="number"
                value={form.maxIssueDaysStudent || 14}
                onChange={e => setForm({ ...form, maxIssueDaysStudent: parseInt(e.target.value) || 1 })}
                className="w-full rounded-xl border border-[#27272a] bg-[#09090b] px-3.5 py-2 text-[#fafafa] focus:outline-none focus:border-emerald-500"
              />
            </div>

            <div className="space-y-1">
              <label className="text-[#a1a1aa] font-medium block">Faculty Max Issue Days</label>
              <input
                type="number"
            ...
            <div className="space-y-1">
              <label className="text-[#a1a1aa] font-medium block">Overdue Fine Per Day ({form.currencySymbol || 'Rs.'})</label>
              <input
                type="number"
