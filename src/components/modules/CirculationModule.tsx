...
export const CirculationModule: React.FC<CirculationModuleProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-5 rounded-2xl bg-[#121214] border border-[#27272a] shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`px-4 py-2.5 rounded-xl text-xs font-bold flex items-center space-x-2 transition-all cursor-pointer shadow-md ${
              activeTab === 'ISSUE'
                ...
                : 'bg-[#18181b] border border-emerald-500/30 text-emerald-400 hover:bg-emerald-950/30'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2.5 rounded-xl text-xs font-bold flex items-center space-x-2 transition-all cursor-pointer shadow-md ${
              activeTab === 'RETURN'
                ...
                : 'bg-[#18181b] border border-blue-500/30 text-blue-400 hover:bg-blue-950/30'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-2 rounded-xl text-xs font-semibold flex items-center space-x-1.5 transition-all cursor-pointer ${
              activeTab === 'HISTORY' ? 'bg-[#27272a] text-white' : 'text-[#a1a1aa] hover:text-white bg-[#09090b]'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-2 rounded-xl text-xs font-semibold flex items-center space-x-1.5 transition-all cursor-pointer ${
              activeTab === 'QR_KIOSK' ? 'bg-purple-600 text-white' : 'text-purple-400 hover:bg-purple-500/10 bg-[#09090b]'
            }`}
          >
      ...
      {activeTab === 'ISSUE' && (
        <div className="space-y-5">
            ...
            <div className="p-4 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-zinc-300 flex flex-wrap gap-x-3 gap-y-1 mt-0.5 font-mono">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg hover:bg-emerald-900/40 text-zinc-400 hover:text-white cursor-pointer"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 p-5 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
              ...
              {selectedMember ? (
                <div className="p-4 rounded-xl bg-[#09090b] border-2 border-emerald-500/50 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#a1a1aa] font-mono mt-0.5">
                        ID: <strong className="text-zinc-200">{selectedMember.memberCode || selectedMember.id}</strong> • Dept: {selectedMember.department || 'General'}
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#09090b] border border-[#27272a] rounded-xl pl-10 pr-3 py-2.5 text-xs text-[#fafafa] focus:outline-none focus:border-emerald-500"
                    />
                  </div>

                  <div className="max-h-64 overflow-y-auto space-y-1.5 pr-1 divide-y divide-[#27272a]/40">
                    {filteredMembers.map(u => (
                      <div
                        key={u.id}
                        onClick={() => setSelectedMemberId(u.id)}
                        className="p-3 rounded-xl hover:bg-[#18181b] transition-all flex items-center justify-between text-xs cursor-pointer group"
                      >
                        <div className="flex items-center space-x-3">
            ...
            <div className="lg:col-span-6 p-5 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
              ...
              {selectedBook ? (
                <div className="p-4 rounded-xl bg-[#09090b] border-2 border-blue-500/50 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <img
                ...
                <div className="space-y-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#09090b] border border-[#27272a] rounded-xl pl-10 pr-3 py-2.5 text-xs text-[#fafafa] focus:outline-none focus:border-blue-500"
                    />
                  </div>
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <img
                            ...
                            alt="cover"
                            className="h-9 w-7 rounded object-cover border border-[#27272a] shrink-0"
                          />
                          <div>
              ...
              <div className="pt-2 border-t border-[#27272a] space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#a1a1aa] font-medium">Loan Period:</span>
                  <div className="flex items-center space-x-2">
                    <button
                      type="button"
                      onClick={() => setLoanPeriodDays(14)}
                      className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-all ${
                        loanPeriodDays === 14 ? 'bg-emerald-600 text-white' : 'bg-[#09090b] text-[#a1a1aa] hover:text-white'
                      }`}
                    >
                      14 Days
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-all ${
                        loanPeriodDays === 30 ? 'bg-emerald-600 text-white' : 'bg-[#09090b] text-[#a1a1aa] hover:text-white'
                      }`}
                    >
                      30 Days (Faculty)
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-all ${
                        loanPeriodDays === 7 ? 'bg-emerald-600 text-white' : 'bg-[#09090b] text-[#a1a1aa] hover:text-white'
                      }`}
                    >
                      7 Days
                    </button>
                ...
                <div className="p-3 rounded-xl bg-[#09090b] border border-[#27272a] flex items-center justify-between text-xs font-mono">
                  <span className="text-[#a1a1aa]">Calculated Due Date:</span>
          ...
          <div className="p-4 rounded-2xl bg-[#121214] border border-[#27272a] space-y-3">
            <h4 className="text-xs font-bold uppercase font-mono text-zinc-400 flex items-center space-x-2">
            ...
            <form onSubmit={handleFastScanIssue} className="grid grid-cols-1 sm:grid-cols-12 gap-3">
              <div className="sm:col-span-5">
                <input
                  ...
                  className="w-full bg-[#09090b] border border-[#27272a] rounded-xl px-3.5 py-2 text-xs text-white font-mono focus:outline-none focus:border-emerald-500"
                />
              </div>
              <div className="sm:col-span-5">
                <input
        ...
        <div className="space-y-5">
            ...
            <div className="p-4 rounded-2xl bg-blue-950/40 border border-blue-500/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg hover:bg-blue-900/40 text-zinc-400 hover:text-white cursor-pointer"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
          ...
          <div className="p-5 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
            {filteredReturnLoans.length === 0 ? (
              <div className="p-8 text-center text-[#a1a1aa] space-y-2">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-[#27272a] text-[#a1a1aa] font-mono text-[11px]">
                  ...
                  <tbody className="divide-y divide-[#27272a]/50">
                    {filteredReturnLoans.map(tx => {
                      ...
                      return (
                        <tr key={tx.id} className="hover:bg-[#18181b]/60 transition-colors">
                          {/* Book Title */}
                          ...
                          <td className="py-3.5 pr-3 font-mono">
                            <span className={isLate ? 'text-red-400 font-bold' : 'text-zinc-200'}>
                              {tx.dueDate}
                            </span>
                          </td>
                          ...
                          <td className="py-3.5 text-right">
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                ...
                                className="p-1.5 rounded-lg bg-[#18181b] hover:bg-[#27272a] border border-[#3f3f46] text-zinc-300 hover:text-white cursor-pointer"
      ...
      {activeTab === 'HISTORY' && (
        <div className="p-5 rounded-2xl bg-[#121214] border border-[#27272a] space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <h3 className="text-xs font-bold uppercase font-mono text-zinc-300 flex items-center space-x-2">
              ...
              {(['ALL', 'ISSUED', 'RETURNED', 'OVERDUE'] as const).map(f => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-mono font-bold cursor-pointer transition-all ${
                    historyFilter === f ? 'bg-[#27272a] text-white' : 'text-[#a1a1aa] hover:text-white'
                  }`}
                >
                  {f}
                </button>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#09090b] border border-[#27272a] rounded-xl pl-10 pr-3 py-2 text-xs text-white focus:outline-none focus:border-emerald-500"
            />
          </div>
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#27272a]/50">
                {filteredHistory.map(tx => (
                  <tr key={tx.id} className="hover:bg-[#18181b]/50">
                    <td className="py-3 font-mono text-zinc-400 text-[11px]">{tx.transactionNumber || tx.id}</td>
                    <td className="py-3 font-bold text-white">{tx.bookTitle}</td>
                    <td className="py-3 font-medium text-zinc-300">{tx.memberName} ({tx.memberCode || tx.memberId})</td>
                    <td className="py-3 font-mono text-zinc-400">{tx.issueDate}</td>
                    ...
                    <td className="py-3 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-[#18181b] hover:bg-[#27272a] border border-[#3f3f46] text-zinc-300 hover:text-white text-xs font-bold inline-flex items-center space-x-1 cursor-pointer"
      ...
      {/* ========================================================================= */}
      {activeTab === 'QR_KIOSK' && (
        <div className="p-6 rounded-2xl bg-[#121214] border border-[#27272a]">
          <MemberQrScanner
            users={users}
            books={books}
